    ...
    <main className="relative min-h-screen font-sans bg-white flex flex-col">
      ...
      <div className="flex-1">
        <HeroSectionTwo
          ...
          description="Comfygen Technologies founded in 2019 with a vision to deliver reliable and scalable digital solutions, Comfygen Technologies provides comprehensive IT consulting, software development, Application Development and digital transformation services."
