...
const videos = [
  {
    ...
    name: 'Nitesh Rajput',
    app: 'Book My Tutor',
    youtubeId: 'Jxv6y3A4GoY' // Client testimonial video
  },
  {
    id: 2,
    name: 'Sayead Shadab Arif',
...
export const Testimonials = () => {
  ...
  const reviewChunks = [reviews.slice(0, 4), reviews.slice(4, 8)];
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start pr-0 lg:pr-8">
          ...
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed mb-10 max-w-lg">
            We Don't Just Deliver Solutions; We Build Lasting Partnerships. Discover The Success Stories And Feedback From Our Clients, Which Stand As A Testament To Our Unwavering Commitment To Quality And Excellence.
          </p>

          <button className="border border-primary text-white hover:bg-primary px-8 py-3.5 rounded-full text-sm font-medium transition-all  hover:shadow-[0_0_20px_rgba(1,88,230,0.4)]">
            Check More
          </button>
        </div>
